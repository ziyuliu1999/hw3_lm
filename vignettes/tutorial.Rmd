...
Here we can see that our code in total spend 469 ms and the original R package used 454 ms, which implies that our code is a little bit slower than the R original Package.
